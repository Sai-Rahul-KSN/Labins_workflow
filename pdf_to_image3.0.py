...
if __name__ == "__main__":
    ...
    input_dir = r"C:\Users\sk23dg\Desktop\Labins_Workflow\PDF_Extractor\test_pdfs"  # Updated input directory
    output_dir = os.path.join(script_dir, "extracted_screenshots")
