...
if __name__ == "__main__":
    ...
    # Define input files (add your Excel file paths here)
    # Example: List of specific files
    input_files = [
        "data_with_images1.xlsx",
        "data_with_images2.xlsx",
        # Add more paths as needed
    ]
    
    # Alternative: Use glob to process all .xlsx files in a directory
    ...
    output_dir = "."  # Or specify e.g., "output/"
